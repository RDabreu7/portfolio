...
(() => {
  ...
  const stylesheet = `
    :host {
      ...
      min-height: 100vh;
      background: var(--doc-desk, #ece8dd);
      padding: 48px 24px;
    ...
    .sheet {
      ...
      margin: 0 auto;
      background: var(--doc-sheet, #fff);
      box-shadow: 0 2px 14px rgba(20, 20, 19, 0.12);
      border-radius: 2px;
      box-sizing: border-box;
      padding: var(--doc-page-margin);
    }
    /* Screen-only page-break guides (approximate): repeat every page
     * height so the paper format is visible on screen. Hosts opt in by
     * setting --doc-guide; transparent by default. */
    .sheet::after {
      content: "";
      position: absolute;
      inset: 0;
      ...
      background: repeating-linear-gradient(to bottom,
        transparent 0,
        transparent calc(var(--doc-page-h) - 1px),
        var(--doc-guide, transparent) calc(var(--doc-page-h) - 1px),
        var(--doc-guide, transparent) var(--doc-page-h));
    }
